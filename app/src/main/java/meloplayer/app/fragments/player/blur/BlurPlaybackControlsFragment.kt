...
import meloplayer.app.databinding.FragmentBlurPlayerPlaybackControlsBinding
import meloplayer.app.extensions.applyColor
import meloplayer.app.extensions.getSongInfo
...
class BlurPlaybackControlsFragment :
    ...
    override fun setColor(color: MediaNotificationProcessor) {
        ...
        lastDisabledPlaybackControlsColor =
            ContextCompat.getColor(requireContext(), meloplayer.appthemehelper.R.color.md_grey_500)
