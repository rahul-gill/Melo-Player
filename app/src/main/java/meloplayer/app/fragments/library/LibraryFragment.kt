 ...
 *
 */
package meloplayer.app.fragments.library
...
import meloplayer.app.databinding.FragmentLibraryBinding
...
class LibraryFragment : AbsMainActivityFragment(R.layout.fragment_library) {
    ...
    private fun setupTitle() {
        ...
        val appName = "Melo<span  style='color:$hexColor';>Player</span>".parseAsHtml()
