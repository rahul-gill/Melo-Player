...
import meloplayer.app.ALBUM_ART_ON_LOCK_SCREEN
import meloplayer.app.BLURRED_ALBUM_ART
import meloplayer.app.BuildConfig
import meloplayer.app.CLASSIC_NOTIFICATION
import meloplayer.app.COLORED_NOTIFICATION
import meloplayer.app.CROSS_FADE_DURATION
import meloplayer.app.GAP_LESS_PLAYBACK
import meloplayer.app.PLAYBACK_PITCH
import meloplayer.app.PLAYBACK_SPEED
import meloplayer.app.R
import meloplayer.app.TOGGLE_HEADSET
import meloplayer.app.activities.LockScreenActivity
import meloplayer.app.appwidgets.AppWidgetBig
import meloplayer.app.appwidgets.AppWidgetCard
import meloplayer.app.appwidgets.AppWidgetCircle
import meloplayer.app.appwidgets.AppWidgetClassic
import meloplayer.app.appwidgets.AppWidgetMD3
import meloplayer.app.appwidgets.AppWidgetSmall
import meloplayer.app.appwidgets.AppWidgetText
import meloplayer.app.auto.AutoMediaIDHelper
import meloplayer.app.auto.AutoMusicProvider
import meloplayer.app.extensions.showToast
import meloplayer.app.extensions.toMediaSessionQueue
import meloplayer.app.extensions.uri
import meloplayer.app.glide.BlurTransformation
import meloplayer.app.glide.RetroGlideExtension.getSongModel
import meloplayer.app.glide.RetroGlideExtension.songCoverOptions
import meloplayer.app.helper.ShuffleHelper.makeShuffleList
import meloplayer.app.model.Song
import meloplayer.app.model.Song.Companion.emptySong
import meloplayer.app.model.smartplaylist.AbsSmartPlaylist
import meloplayer.app.providers.HistoryStore
import meloplayer.app.providers.MusicPlaybackQueueStore
import meloplayer.app.providers.SongPlayCountStore
import meloplayer.app.service.notification.PlayingNotification
import meloplayer.app.service.notification.PlayingNotificationClassic
import meloplayer.app.service.notification.PlayingNotificationImpl24
import meloplayer.app.service.playback.Playback.PlaybackCallbacks
import meloplayer.app.service.playback.PlaybackSleepTimer
import meloplayer.app.service.player.PlaybackManagerNew
import meloplayer.app.service.player.util.NoisyDeviceSwitchWatcher
import meloplayer.app.service.util.BluetoothWatcher
import meloplayer.app.util.MusicUtil
import meloplayer.app.util.MusicUtil.toggleFavorite
import meloplayer.app.util.PackageValidator
import meloplayer.app.util.PreferenceUtil
import meloplayer.app.util.PreferenceUtil.crossFadeDuration
import meloplayer.app.util.PreferenceUtil.isAlbumArtOnLockScreen
import meloplayer.app.util.PreferenceUtil.isBlurredAlbumArt
import meloplayer.app.util.PreferenceUtil.isClassicNotification
import meloplayer.app.util.PreferenceUtil.isHeadsetPlugged
import meloplayer.app.util.PreferenceUtil.isLockScreen
import meloplayer.app.util.PreferenceUtil.isPauseOnZeroVolume
import meloplayer.app.util.PreferenceUtil.playbackPitch
import meloplayer.app.util.PreferenceUtil.playbackSpeed
import meloplayer.app.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import meloplayer.app.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import meloplayer.app.volume.AudioVolumeObserver
import meloplayer.app.volume.OnAudioVolumeChangedListener
...
//        playbackManager.switchToRemotePlayback(castPlayer, this::restorePlaybackState)
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "meloplayer.app"
