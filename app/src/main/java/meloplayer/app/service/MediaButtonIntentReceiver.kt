...
import meloplayer.app.service.MusicService.Companion.ACTION_PAUSE
import meloplayer.app.service.MusicService.Companion.ACTION_PLAY
...
import meloplayer.app.service.MusicService.Companion.ACTION_STOP
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "MeloPlayer:Wakelock headset button"
                )
