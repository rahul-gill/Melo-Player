...
import meloplayer.app.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_A_Z
import meloplayer.app.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_SONG_COUNT
import meloplayer.app.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_SONG_COUNT_DESC
import meloplayer.app.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_Z_A
...
class RealRoomRepository(
    ...
    override suspend fun playlistWithSongs(): List<PlaylistWithSongs>{
        ...
        return when (PreferenceUtil.playlistSortOrder) {
            ...
            PLAYLIST_Z_A -> playlistDao.playlistsWithSongs().sortedWith { p1, p2 ->
